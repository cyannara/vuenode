...
| BACK_PATH  | /home/ubuntu/app/backapp | node 소스 위치           |
    ...
    steps:
      ...
      - name: Upload to Server
        ...
        with:
          ...
          key: ${{ secrets.KEY }}
          source: "backapp/*"
          target: /home/ubuntu/app/backapp
          rm: true
          strip_components: 1
...
vscode에서 소스를 수정하고 commit -> push
commit 메시지가 워크플로이름이 됨
